                ...
                <div class="x_content">
                    ...
                    <tbody class="productresult">
                      ...
                      <tr>
                          ...
                          <td>{{number_format($branchProduct->price,2)}}</td>
    ...
    <div class="col-md-8 col-sm-8 col-xs-12">
        <div class="x_panel">
                ...
                <div class="x_content">
                  ...
                  <input type="text"  name="money" value="<?php echo number_format($amount,2); ?> " id="money" style="text-align: right;" class="form-control" disabled>
                  </div>
                  <form action="/cashier/cart/processOrder" method="post">
                    ...
                    <div class="form-group col-lg-4">
                      ...
                      <input type="text"  name="money" value="" id="money" style="text-align: right;" class="form-control">
                    ...
                    <div class="form-group col-lg-4">
                      ...
                      <input type="text"  name="ornumber" value="" id="ornumber" style="text-align: right;" class="form-control">
