                  ...
                  <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td> <a href="/checker/products/{{$Product->prod_id}}">{{$Product->product->product_name}}</a></td>
                        ...
                        <a href="/checker/products/{{$Product->prod_id}}" class="btn btn-success btn-small" > <i class="btn-icon-only icon-search"> </i>View</a>
