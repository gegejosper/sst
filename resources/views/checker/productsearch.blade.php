        ...
        <div class="widget widget-table action-table" >
            ...
            @foreach($dataProductquantity as $Productquantity)
                      <div class="col-lg-3">      
                        ...
                        <table class="table table-striped table-bordered">
                          ...
                          <tbody>
                            ...
                            <td align="center" style="text-align:center" width="100px"> <a href="#" class="avatar"><img src="{{asset('/productimg')}}/{{$Productquantity->pic}}" width="50px"/></td>
                    ...
                    if($dataQuantity->quantity<=0){
                      ...
                      ?>
                              <a href="javascript:;" class="edit-modal btn btn-success btn-small" data-pic="{{$Productquantity->pic}}" data-amount="{{$dataQuantity->price}}.00" data-quantity="{{$dataQuantity->quantity}}.00" data-name="{{$Productquantity->product_name}}" data-id="{{$dataQuantity->id}}" ><i class="btn-icon-only icon-shopping-cart"> </i><span style="color:#fff;">Add to Cart</span></a></td>
                    <?php }
                    ?>
                            </tr>  
...
<script src="{{ asset('js/cashiercartsearchscript.js') }}"></script>
<!-- /main -->
@endsection