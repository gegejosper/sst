            ...
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                  ...
                  <tr class="item{{$Booking->id}}">
                    ...
                    <td><a href="/admin/bookings/{{$Booking->id}}" style="text-transform:capitalize;">{{$Booking->name}}</a></td>
                    ...
                    <td style="width:100px;" class="td-actions">
                        <a href="/admin/bookings/{{$Booking->id}}" class="btn btn-mini btn-success" data-id="{{$Booking->id}}" ><i class="icon-search"> </i> View</a>
                        ...
                        <?php 
                          ...
                          if($Booking->status == 1) {
                             ?>
                                  <a href="javascript:;" class="cancel-modal btn btn-mini btn-warning" data-id="{{$Booking->id}}" ><i class="icon-remove"> </i> Cancel</a>     
                             <?php
                          }
                          else {
                          ?>
