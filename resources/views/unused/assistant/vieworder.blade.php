      ...
      <table class="table table-striped table-bordered" id="table">
                ...
                <?php $amount =0; ?>
                  ...
                  <tr class="item{{$order->item_id}}">
                    <td width="250px"> <a href="/products/{{$order->item_id}}" class="name" target="_blank">
                    ...
                    data-quantity="{{$order->rquantity}}" data-name="{{$order->product_name}}" class="btn btn-mini btn-info updatecart" data-id="{{$order->item_id}}" data-reqid="{{$order->req_id}}">
                    <i class="icon-plus"></i> <span style="color:#fff;">Add to Purchase</span>
                    </a>
                   
                   
                    <a href="/cashier/declineorder/{{$order->item_id}}/{{$order->req_id}}" class="btn btn-mini btn-danger" data-id="{{$order->item_id}}" data-reqid="{{$order->req_id}}" id="deleteproduct">
