                ...
                <tbody>
                  ...
                  <tr class="item{{$Transport->id}}">
                    ...
                    <td style="width:100px;" class="td-actions">
                        ...
                        <a href="javascript:;" class="disapprove-modal btn btn-mini btn-warning" data-id="{{$Transport->id}}" ><i class="icon-remove"> </i> Cancel</a> 
                        <?php 
                          }
                          if($Transport->status != 1) {
                          ?>
...
<script src="{{ asset('js/transportAssistant.js') }}"></script>
<!-- /main -->
@endsection