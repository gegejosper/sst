...
<div class="subnavbar noprint">
  <div class="subnavbar-inner">
    <div class="container">
      <ul class="mainnav">
        <li><a href="/accounting/dashboard"><i class="icon-dashboard"></i><span>Dashboard</span> </a> </li>
        <!-- <li><a href="/admin/shop"><i class="icon-shopping-cart" aria-hidden="true"></i><span>Shop</span> </a></li> -->
        <li><a href="/accounting/products"><i class="icon-qrcode" aria-hidden="true"></i><span>Products</span> </a></li>
        <li><a href="/accounting/stocks"><i class="icon-th" aria-hidden="true"></i><span>Stocks</span> </a></li>
        <li><a href="/accounting/distribution"><i class="icon-retweet" aria-hidden="true"></i><span>Distribution</span> </a></li>
        <li><a href="/accounting/purchase"><i class="icon-folder-open" aria-hidden="true"></i><span>Purchase Orders</span> </a></li>
        <!-- <li><a href="/admin/members"><i class="icon-user"></i><span>Members</span> </a> </li> -->
        <li><a href="/accounting/subscribers"><i class="icon-group"></i><span>Subscribers</span> </a> </li>
        <li><a href="/accounting/branchs"><i class="icon-sitemap"></i><span>Branch</span> </a> </li>
        <li><a href="/accounting/report"><i class="icon-list-alt"></i><span>Report</span> </a> </li>
