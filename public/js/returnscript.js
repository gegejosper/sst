$(document).ready(function() {
    ...
    $('textarea[name=returnnote]').on("keyup", function () {
        $('#returnorder').prop('disabled', false); 
    });
    $(document).on('click', '.edit-modal', function() {
          $('#footer_action_button').text("Add to Returns");
          $('#footer_action_button').addClass('glyphicon-check');
          $('#footer_action_button').removeClass('glyphicon-trash');
          $('.actionBtn').addClass('btn-success');
          $('.actionBtn').removeClass('btn-danger');
          $('.actionBtn').addClass('edit');
          $('.modal-title').text('Add to Return Quantity');
          $('.deleteContent').hide();
    ...
    $('.modal-footer').on('click', '.updatequantity', function() {
        ...
        $.ajax({
            type: 'post',
            url: '/cashier/return/updatequantity',
            data: {
