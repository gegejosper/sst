$(document).ready(function() {
    $(document).on('click', '.editPrice', function() {
      ...
      $(document).on('click', '.editPriceAdmin', function() {
        $('#footer_action_button').text("Update");
        $('#footer_action_button').addClass('glyphicon-check');
        $('#footer_action_button').removeClass('glyphicon-trash');
        $('.actionBtn').addClass('btn-success');
        $('.actionBtn').removeClass('btn-danger');
        $('.actionBtn').addClass('editAdmin');
        $('.modal-title').text('Set Product Price');
        $('.deleteContent').hide();
        $('.form-horizontal').show();
        $('#fid').val($(this).data('id'));
        ...
        $('#productedit_name').text($(this).data('name'));
        $('#productamount').text($(this).data('amount'));
        $('#productamount').val($(this).data('amount'));
        $('#branchquantity').val($(this).data('quantity'));
        $('#myModal').modal('show');
        //console.log($(this).data('name') + $(this).data('points'));
    });
    ...
    $('.modal-footer').on('click', '.editAdmin', function() {
